...
export const storyContent = {
  es: {
    ...
    directAnswer:
      ...
      'A principios de 2026, Santiago Fernández de Valderrama Aparicio llevó su búsqueda de empleo como un pipeline de operaciones: 740 ofertas evaluadas, 68 solicitudes, 12 entrevistas, 1 oferta firmada. Después liberó el sistema como career-ops (MIT, gratis): 62.2K+ estrellas en GitHub (a julio de 2026). Y el CEO que le contrató le encontró por el sistema. Sin solicitud de por medio.',
    sections: {
      'sixteen-years': {
      ...
      'open-source': {
        ...
        paras: [
          ...
          'Se hizo viral: más de 12.000 estrellas en los dos primeros días. Hoy career-ops tiene 62.2K+ estrellas en GitHub (a julio de 2026), 12.2K+ forks, más de 180 contribuidores y una comunidad en Discord de 4.300+ miembros. Business Insider (abril 2026) y WIRED Grecia (abril 2026) lo cubrieron como caso de cómo la IA está reequilibrando el embudo de contratación desde el lado del candidato.',
        ],
      },
      'the-reversal': {
  ...
  en: {
    ...
    directAnswer:
      ...
      'In early 2026, Santiago Fernández de Valderrama Aparicio ran his job search as an operations pipeline: 740 job listings evaluated, 68 applications, 12 interviews, 1 signed offer. He then open-sourced the system as career-ops (MIT, free): 62.2K+ GitHub stars (as of July 2026). And the CEO who hired him found him through the system. No application involved.',
    sections: {
      'sixteen-years': {
      ...
      'open-source': {
        ...
        paras: [
          ...
          'It went viral: 12,000+ stars in the first two days. Today career-ops has 62.2K+ GitHub stars (as of July 2026), 12.2K+ forks, 180+ contributors and a Discord community of 4,300+ members. Business Insider (April 2026) and WIRED Greece (April 2026) covered it as a case of AI rebalancing the hiring funnel from the candidate side.',
        ],
      },
      'the-reversal': {
