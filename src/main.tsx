import { StrictMode, lazy, Suspense, useState, useEffect, useRef, Component, type ReactNode, type ComponentType, type LazyExoticComponent } from 'react'
...
const articleComponents: Record<string, LazyExoticComponent<ComponentType<{ lang: 'en' }>>> = {}
for (const article of articleRegistry) {
  articleComponents[article.id] = lazy(article.component) as LazyExoticComponent<ComponentType<{ lang: 'en' }>>
}
...
console.log('%c I build the details. Let\'s solve something hard → ayazzia01@gmail.com ', 'background: #f97316; color: #1a1a1a; font-size: 13px; font-weight: bold; padding: 4px 8px; border-radius: 3px;')

// Debug API for technical recruiters — type window.__ayaz in console
Object.defineProperty(window, '__ayaz', {
  value: Object.freeze({
...
function NotFound() {
  useEffect(() => {
    ...
    document.title = '404 — Page not found | Ayaz'
