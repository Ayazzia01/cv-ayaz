...
export function ArticleHeader({
  ...
  dateModifiedISO,
  readingTime,
  authorName = 'Ayaz Zia Ansari',
  authorUrl,
  authorBio,
  avatarSrc = '/ayaz-avatar.png',
  lang,
}: ArticleHeaderProps) {
...
export function ArticleFooter({ lang }: ArticleFooterProps) {
  ...
  const fellowUrl = `https://maven.com/marily-nika/ai-pm-bootcamp`
  return (
    <footer className="mt-16 pt-8 border-t border-border">
      <div className="flex items-start gap-3 mb-6">
        ...
        />
        <div>
          <p className="font-medium text-foreground">Ayaz Zia Ansari</p>
      ...
      <div className="flex gap-3 mb-8">
        <a href="https://linkedin.com/in/ayazziaansari" target="_blank" rel="me noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#0A66C2]/10 border border-[#0A66C2]/20 text-sm font-medium text-[#0A66C2] hover:bg-[#0A66C2]/20 transition-colors">
        ...
        <a href="https://github.com/Ayazzia01" target="_blank" rel="me noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-card border border-border text-sm font-medium text-muted-foreground hover:text-foreground hover:border-primary/30 transition-colors">
      ...
      <div className="flex items-center gap-3 text-xs text-muted-foreground">
        <span>&copy; {new Date().getFullYear()} Ayaz Zia Ansari. {f.copyright}</span>
