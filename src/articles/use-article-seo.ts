...
export function useArticleSeo(opts: ArticleSeoOpts) {
  useEffect(() => {
    ...
    const url = `https://cv-ayaz.vercel.app/${slug}`
    const altUrl = `https://cv-ayaz.vercel.app/${altSlug}`
    ...
    upsertMeta('name', 'author', 'Ayaz Zia Ansari')
    ...
    upsertMeta('property', 'og:site_name', 'Ayaz Zia Ansari')
    ...
    upsertMeta('property', 'article:author', 'https://www.linkedin.com/in/ayazziaansari')
    ...
    for (const { hreflang, href } of [
      ...
      { hreflang: 'x-default', href: `https://cv-ayaz.vercel.app/${defaultSlug}` },
    ]) {
...
export function useHomeSeo({ lang, title, description }: { lang: string; title: string; description: string }) {
  useEffect(() => {
    ...
    const canonical = 'https://cv-ayaz.vercel.app/'
