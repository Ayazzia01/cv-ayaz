...
export const careerOpsContent = {
  es: {
    ...
    header: {
      kicker: 'Case Study: De proyecto personal a 63.5K+ stars',
      h1: 'career-ops: Cómo un Agente IA Automatizó Mi Búsqueda de Empleo',
      subtitle: 'Construí un sistema multi-agente para automatizar mi búsqueda de empleo. Funcionó: ahora soy Head of Applied AI. Luego lo abrí como open source y se hizo viral — 63.5K+ estrellas en GitHub.',
    ...
    sections: {
      intro: {
        hook: 'Construí un sistema de IA para buscar trabajo. Funcionó — ahora soy Head of Applied AI. Luego lo publiqué en GitHub y explotó: 63.5K+ estrellas, viral, artículos en Francia, China y Corea. La primera semana buscando trabajo en IA lo hice todo manual. La segunda semana ya no aplicaba — estaba construyendo career-ops.',
      ...
      results: {
        ...
        metrics: [
          { value: '740', label: 'Ofertas evaluadas' },
          { value: '63.5K+', label: 'GitHub stars' },
          { value: '1', label: 'Oferta firmada' },
  ...
  en: {
    ...
    header: {
      kicker: 'Case Study: From side project to 63.5K+ stars',
      h1: 'career-ops: How I Built an AI Job Search System That Got Me Hired',
      subtitle: 'I built a multi-agent system to automate my job search. It worked — I am now Head of Applied AI. Then I open-sourced it and it went viral — 63.5K+ GitHub stars.',
    ...
    sections: {
      intro: {
        hook: 'I built an AI system to search for a job. It worked — I am now Head of Applied AI. Then I published it on GitHub and it exploded: 63.5K+ stars, viral, articles in France, China, and Korea. Week one of my AI job search was all manual. By week two I had stopped applying — I was building career-ops.',
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'I did — Santiago Fernández de Valderrama (santifer). I built it for my own AI job search after spending 16 years founding and selling a phone repair business. The system evaluated 740 offers and helped me land my current role as Head of Applied AI. When I no longer needed it, I published it as open source and it went viral — today it has passed 63.5K+ GitHub stars. The Discord community is now 4,400+ people: discord.gg/8pRpHETxa4',
        },
      ],
    },
  },
